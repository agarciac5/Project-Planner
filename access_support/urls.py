...
urlpatterns = [
    ...
    path("docentes/", TeacherListView.as_view(), name="teacher_list"),
    path("docentes/crear/", TeacherCreateView.as_view(), name="teacher_create"),
    path("docentes/<int:pk>/editar/", TeacherUpdateView.as_view(), name="teacher_edit"),
    path("docentes/<int:pk>/eliminar/", TeacherDeleteView.as_view(), name="teacher_delete"),
